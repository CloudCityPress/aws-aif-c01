## Задача 3.4: Описание методов оценки производительности базовых моделей

Запуск приложения на основе базовой модели без структурированного плана оценки — это эквивалент выпуска программного обеспечения без тестирования. Модель может хорошо выглядеть на обобщённых тестах, но при этом не справляться с бизнес-задачей, для которой она создана, или достигать технических целей точности, в то время как пользователи незаметно перестают ею пользоваться. Эта задача охватывает измерение производительности базовых моделей на трёх отдельных уровнях: сама модель, приложение, построенное поверх неё, и бизнес-результат, для достижения которого она была развёрнута.[^304001]
